...
items:1},748:{items:1},940:{items:1}}}),$(".banners__content").masonry({itemSelector:".banners__item",singleMode:!1,isResizable:!0,gutter:20});var t;$(".banners__submit").click(function(){t=$(".banners__search").val(),e(t)});var e=function(t){$.get("https://api.riffsy.com/v1/search?key=LIVDSRZULELA&tag="+t+"&limit=7",function(t){$(".banners__content").html("");for(var e=0;e<t.results.length;e++)$(".banners__content").append('<div class="banners__item"><img src='+t.results[e].url+' height="308" width="620"></div>')},"json")}});